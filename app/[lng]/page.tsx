...
export default async function Index({ params: { lng } }: IndexProps) {
  ...
  const canInitSupabaseClient = () => {
    ...
    try {
      console.log("cookies.toString 是" , cookies.toString )
      
      supabase = createClient(cookieStore);

      return true;
    } catch (e) {
      console.log("----\app\[lng]\page.tsx：canInitSupabaseClient----", e);
      return false;
    }
  };
  ...
  console.log("----\app\[lng]\page.tsx：user in page----", user);
  return (
